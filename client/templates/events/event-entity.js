...
Template.eventEntity.helpers({
		menuItems: function(){
				return Items.find(); //subscription returns only items that belongs to this event
		},
		showDate: function(){
		...
		groupName: function(){
				var group = CreatedGroups.findOne({_id:this.group});
